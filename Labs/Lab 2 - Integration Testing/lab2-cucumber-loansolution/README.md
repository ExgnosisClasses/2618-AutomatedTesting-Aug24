# Lab 2.1 -- Integration Testing with Cucumber and Gherkin (SOLUTION)

**COMPLETED SOLUTION** for Lab 2 - Integration Testing of the Software Test
Automation Survey course.

The feature file and step definitions are already written. Use this to verify
student work or to run the full suite. Students should receive
`lab2-1-cucumber-loan` instead.
...
| File | Part |
|---|---|
| `src/test/resources/features/loan_eligibility.feature` | complete |
| `src/test/java/com/example/loans/LoanEligibilitySteps.java` | complete |
...
└── src/
    ...
    └── test/
        ...
        │   └── LoanEligibilitySteps.java <- complete
        └── resources/features/
            └── loan_eligibility.feature  <- complete
```
