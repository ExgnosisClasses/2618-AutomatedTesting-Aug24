# Lab 3.1 -- End-to-End Testing with Selenium (Java)
...
`BasePage.java` is provided. The other three page objects and the test class
contain numbered `TODO` comments — replace each with the code from the lab
instructions.
